...
#? Install CLI
sh $SDK_EXTRACTED_PATH/install.sh

#? Add to PATH
export PATH="$SDK_EXTRACTED_PATH/completion.bash.inc:$PATH"
export PATH="$SDK_EXTRACTED_PATH/path.bash.inc:$PATH"
source $SDK_EXTRACTED_PATH/completion.bash.inc
source $SDK_EXTRACTED_PATH/path.bash.inc